...
import { FaAddressBook, FaFacebook, FaInstagram, FaLinkedin, FaTwitter } from "react-icons/fa";
    ...
    <div className="px-[2rem] sm:px-[4rem] lg:px-[5rem] pt-[16.5rem]">
        ...
        <div className="max-w-md">
          ...
          <div className="flex items-center space-x-2 mb-4">
            <img
              ...
              className="w-8 h-8"
            />
            <span className="text-white text-2xl sm:text-3xl font-bold">QUICKDAAK</span>
          </div>
        ...
        <div className="w-[100%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 relative">
          ...
          <div className="">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-white/80 hover:text-white text-sm sm:text-base">
                  About Us
                </a>
              </li>
              <li>
      ...
      <div className="mt-12 sm:mt-16 pt-8 pb-4 border-t border-white/20">
        <p className="text-center text-white/70 text-xs sm:text-sm">
          Copyright © {new Date().getFullYear()} QUICKDAAK. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
